...
function CharacterLoadingFallback({ color }: { color: string }) {
  return (
...
function SvoltaCashier({
  ...
  return (
    <group
      ...
      name="svolta-cashier"
    >
      <Suspense fallback={<CharacterLoadingFallback color="#f7f5ef" />}>
        <AnimatedJourneyCharacter
  ...
  return (
    <>
      <group ref={attendant} visible={Boolean(cue)} name="q8-attendant">
        <Suspense fallback={<CharacterLoadingFallback color="#13337a" />}>
          <AnimatedJourneyCharacter
