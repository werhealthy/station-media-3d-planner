...
export const JOURNEY_OBSTACLES: PlanarBounds[] = [
  ...
  { id: 'roadside-landscape', minX: -9.2, maxX: 9.2, minZ: 10.9, maxZ: 13 },
  { id: 'pedestrian-curb', minX: -10.5, maxX: 10.5, minZ: 12.1, maxZ: 13.2 },
  ...
  {
    id: 'shop-support-mp06',
    minX: L.entry.standardSignX - 0.75,
    maxX: L.entry.standardSignX + 0.75,
    minZ: L.entry.standardSignZ - 0.65,
    maxZ: L.entry.standardSignZ + 0.65,
  },
  { id: 'backdrop-mp07', minX: -4.75, maxX: -1.45, minZ: -4.6, maxZ: -3.95 },
  {
    id: 'stendardo-mp08',
    minX: L.entry.stendardoX - 0.6,
    maxX: L.entry.stendardoX + 0.6,
    minZ: L.entry.stendardoZ - 0.45,
    maxZ: L.entry.stendardoZ + 0.45,
  },
  {
    id: 'beach-flag-mp09',
    minX: L.entry.beachFlagX - 0.6,
    maxX: L.entry.beachFlagX + 0.6,
