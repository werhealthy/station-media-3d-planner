...
export const JOURNEY_OBSTACLES: PlanarBounds[] = [
  ...
  { id: 'pedestrian-curb-left', minX: -23, maxX: -10, minZ: 12.1, maxZ: 13.2 },
  { id: 'pedestrian-curb-right', minX: -3, maxX: 0, minZ: 12.1, maxZ: 13.2 },
  ...
  { id: 'pump-leader-mp02', minX: 7.3, maxX: 8.5, minZ: 1.6, maxZ: 2.4 },
  {
    id: 'smartopt-mp05',
