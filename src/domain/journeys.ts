  ...
  return [
    {
      ...
      phase: contactPhase,
      label: 'Raggiunge la pompa e abbassa lo sguardo verso il punto di presa',
...
const servedSteps: JourneyStep[] = [
  ...
  },
  {
    id: 'served-refuel',
    phase: 'A3 · Attesa durante il rifornimento',
    label: 'Durante l’attesa osserva naturalmente i supporti vicini',
    position: SERVED_STOP,
