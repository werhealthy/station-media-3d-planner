...
function selfFuelSteps(prefix: 'self' | 'svolta'): JourneyStep[] {
  ...
  return [
    ...
    },
    {
      ...
      phase: dwellPhase,
      label: 'Senza lasciare la presa alza appena lo sguardo verso la colonna',
      position: [-1.9, 1.69, 4.2],
      gazeTarget: [-1.2, 1.55, 3.45],
      duration: 6,
      cameraMode: 'pedestrian',
      motion: 'glance',
      mediaPointId: 'mp-03',
    ...
    },
    {
      ...
      phase: dwellPhase,
      label: 'Ruota leggermente la testa, mantenendo corpo e mano sulla pompa',
      position: [-1.9, 1.69, 4.2],
      gazeTarget: [-3.7, 1.52, 3.05],
      duration: 6,
      cameraMode: 'pedestrian',
      motion: 'glance',
      mediaPointId: 'mp-04',
