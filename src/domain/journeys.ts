...
function commonArrivalSteps(
  ...
  return [
    {
      id: 'common-stendardo',
      phase: 'Ingresso · Stendardo',
      label: 'Lo Stendardo apre la sequenza prima della svolta',
      position: [30.2, 1.28, 16.45],
      gazeTarget: [L.entry.stendardoX, 2.9, L.entry.stendardoZ],
      duration: 4.8,
      cameraMode: 'vehicle',
      motion: 'drive',
      mediaPointId: 'mp-08',
      checkpoint: 'Stendardo',
      actor: waitingOperator,
    },
    {
      id: 'common-beach-flag',
      phase: 'Ingresso · Beach Flag',
      label: 'La Beach Flag rafforza il messaggio accanto all’ingresso',
      position: [26.1, 1.28, 16.45],
      gazeTarget: [L.entry.beachFlagX, 2.15, L.entry.beachFlagZ],
      duration: 3.2,
      cameraMode: 'vehicle',
      motion: 'drive',
      mediaPointId: 'mp-09',
      checkpoint: 'Beach Flag',
      actor: waitingOperator,
    },
    {
      id: 'common-open',
    ...
    },
    {
      ...
      label: 'Il Sagomato Standard introduce l’ingresso dello shop',
      position: [14.65, 1.28, 7.9],
    ...
    },
    {
      ...
      phase:
        service === 'servito'
          ? 'A1 · Accostamento all’erogatore Servito'
          : 'Self · Accostamento all’erogatore',
      label: 'Completa l’accostamento parallelo all’erogatore',
      position: stop,
      ...
      mediaPointId: 'mp-01',
      checkpoint: 'Auto accostata all’erogatore',
      actor: waitingOperator,
    },
  ]
}
...
function selfFirstContactStep(): JourneyStep {
  return {
    ...
    phase: 'B1 · Accostamento all’erogatore Self',
    label: 'Memorizza il numero dell’erogatore; la triade resta periferica',
    position: SELF_STOP,
  ...
  return [
    ...
    screenStep('self-review', 'Controlla il riepilogo e conferma', 'review', 3),
    {
      ...screenStep(
        ...
        'Riceve la conferma e può tornare all’erogatore',
        'confirmed',
        3.5,
      ),
  ...
  return [
    {
      ...
      phase: contactPhase,
      label:
        'Raggiunge l’erogatore e abbassa lo sguardo verso il punto di presa',
      position: [-2.4, 1.69, 3.35],
      gazeTarget: [-4.6, 0.72, 2.25],
      duration: 2.8,
      cameraMode: 'pedestrian',
      motion: 'walk',
    ...
    },
    {
      id: `${prefix}-refuel`,
      phase: contactPhase,
      label: 'Avvia il rifornimento controllando in basso il punto di innesto',
      position: [-2.4, 1.69, 3.35],
      gazeTarget: [-4.6, 0.72, 2.25],
      duration: 3,
      cameraMode: 'pedestrian',
    ...
    },
    {
      ...
      phase: dwellPhase,
      label: 'Alza lo sguardo e osserva il Pannello Colonna',
      position: [-2.4, 1.69, 3.35],
      gazeTarget: [L.canopy.columnX, 1.65, -0.86],
      duration: 5,
      cameraMode: 'pedestrian',
      motion: 'glance',
      mediaPointId: 'mp-03',
    ...
    },
    {
      ...
      phase: dwellPhase,
      label: 'Poi ruota lo sguardo verso la triade dell’erogatore',
      position: [-2.4, 1.69, 3.35],
    ...
    {
      id: `${prefix}-refuel-complete`,
      phase: finishPhase,
      label: 'Il servizio termina senza interrompere la continuità della vista',
      position: [-2.4, 1.69, 3.35],
      gazeTarget: [-4.6, 1.45, 2.55],
      duration: 2.2,
      cameraMode: 'pedestrian',
      motion: 'hold',
    ...
    },
    {
      ...
      phase: finishPhase,
      label: 'Lascia con calma l’area di servizio e torna verso l’auto',
    ...
    },
    {
      ...
      position: [-7.3, 1.69, 4.1],
      gazeTarget: [-4.6, 1.3, 4.1],
      duration: 1.8,
      cameraMode: 'pedestrian',
      motion: 'walk',
    },
  ...
  return [
    {
      ...
      phase,
      label: 'Controlla la corsia e lascia gradualmente l’erogatore',
      position,
...
const servedSteps: JourneyStep[] = [
  ...
  },
  {
    ...
    label: 'Il gestore aggira l’auto e raggiunge il fronte dell’erogatore',
    position: SERVED_STOP,
  ...
  },
  {
    ...
    phase: 'A3 · Attesa durante il rifornimento',
    label: 'Il gestore avvia il servizio mentre la regia resta sul contesto',
    position: SERVED_STOP,
    gazeTarget: [0, 1.45, 5.6],
    duration: 0.9,
    cameraMode: 'vehicle',
    motion: 'hold',
    vehicleYaw: WESTBOUND,
    actor: attendant([6.45, 0, 4.35], [4.6, 1.45, 2.4], 'refuel'),
    nozzle: { owner: 'attendant', pump: 'servito', state: 'hand' },
  },
  {
    id: 'served-carry-nozzle',
    phase: 'A3 · Attesa durante il rifornimento',
    label: 'Lo sguardo si apre sul piazzale senza mostrare il gesto tecnico',
    position: SERVED_STOP,
    gazeTarget: [0, 1.45, 5.6],
    duration: 0.8,
    cameraMode: 'vehicle',
  ...
  },
  {
    ...
    phase: 'A3 · Attesa durante il rifornimento',
    label: 'Il rifornimento è in corso',
    position: SERVED_STOP,
    gazeTarget: [0, 1.45, 5.6],
    duration: 0.8,
    cameraMode: 'vehicle',
  ...
  },
  {
    id: 'served-refuel',
    phase: 'A3 · Attesa durante il rifornimento',
    label: 'Durante l’attesa torna a guardare davanti a sé',
    position: SERVED_STOP,
    gazeTarget: [0, 1.45, 5.6],
    duration: 4.5,
    cameraMode: 'vehicle',
  ...
  },
  {
    ...
    phase: 'A3 · Attesa durante il rifornimento',
    label: 'Davanti a sé il Fondostazione entra naturalmente nel campo visivo',
    position: SERVED_STOP,
    gazeTarget: [-3.1, 2.49, -4.28],
    duration: 4,
    cameraMode: 'vehicle',
    motion: 'glance',
    vehicleYaw: WESTBOUND,
  ...
  },
  {
    ...
    phase: 'A3 · Attesa durante il rifornimento',
    label: 'Conclude la panoramica tornando a osservare il piazzale',
    position: SERVED_STOP,
    gazeTarget: [0, 1.5, 5.6],
    duration: 3.5,
    cameraMode: 'vehicle',
    motion: 'glance',
    vehicleYaw: WESTBOUND,
  ...
  },
  {
    ...
    phase: 'A3 · Attesa durante il rifornimento',
    label: 'Il servizio termina fuori campo',
    position: SERVED_STOP,
    ...
    motion: 'hold',
    vehicleYaw: WESTBOUND,
    actor: attendant([6.45, 0, 4.35], SERVED_STOP, 'refuel'),
    nozzle: { owner: 'attendant', pump: 'servito', state: 'hand' },
  },
  {
    id: 'served-carry-back',
    phase: 'A3 · Attesa durante il rifornimento',
    label: 'Il gestore completa il servizio',
    position: SERVED_STOP,
    gazeTarget: [4.6, 1.35, 4.15],
    duration: 1,
    cameraMode: 'vehicle',
  ...
  },
  {
    ...
    phase: 'A3 · Attesa durante il rifornimento',
    label: 'La regia torna sul dialogo con il cliente',
    position: SERVED_STOP,
    gazeTarget: [4.6, 1.35, 4.15],
    duration: 1.2,
    cameraMode: 'vehicle',
    motion: 'hold',
    vehicleYaw: WESTBOUND,
    actor: attendant([6.45, 0, 4.35], SERVED_STOP, 'return'),
...
const selfServiceSteps: JourneyStep[] = [
  ...
  },
  {
    ...
    label: 'Ritorna all’erogatore con un carico cognitivo più basso',
    position: [-7.3, 1.69, 3.2],
    gazeTarget: [-5.65, 1.33, 2.09],
    duration: 2,
    cameraMode: 'pedestrian',
