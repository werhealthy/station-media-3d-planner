...
const servedSteps: JourneyStep[] = [
  ...
  },
  {
    ...
    motion: 'hold',
    vehicleYaw: WESTBOUND,
    actor: attendant([7.05, 0, 3.05], [6.75, 1.05, 4.75], 'carry-nozzle'),
    nozzle: { owner: 'attendant', pump: 'servito', state: 'hand' },
  },
  {
    ...
    motion: 'hold',
    vehicleYaw: WESTBOUND,
    actor: attendant([6.9, 0, 4.15], [6.75, 1.05, 4.75], 'insert-nozzle'),
  ...
  },
  {
    ...
    motion: 'hold',
    vehicleYaw: WESTBOUND,
    actor: attendant([6.9, 0, 4.15], [6.75, 1.05, 4.75], 'remove-nozzle'),
