  ...
  return [
    {
      ...
      phase: contactPhase,
      label:
        'Si posiziona accanto all’auto; il gesto tecnico resta fuori campo',
    ...
    },
    {
      id: `${prefix}-refuel`,
      phase: dwellPhase,
      label: 'Il rifornimento procede fuori campo mentre osserva i supporti',
      position: [-2.4, 1.69, 3.35],
      gazeTarget: [-3.55, 1.65, 3.45],
      duration: 12,
      cameraMode: 'pedestrian',
    ...
    },
    {
      ...
      phase: dwellPhase,
      label: 'Sposta naturalmente lo sguardo verso la triade',
      position: [-2.4, 1.69, 3.35],
